...
- [Done] **For each Java source file in `src/main/java/`, fix all CheckStyle issues that are detected.**
...
- [Done] When you are done, commit your work with **a commit message that includes the string `Task 1.1`**.
...
- [Done] Run the command `git log --oneline` in the terminal and copy+paste the output into
...
- [Done] Commit your changes to `log.txt` now; **include the string `Task 1.2` in your commit message.** 
